...
full_champion.forEach((champ) => {
  buildss.push(`<a href="/champions/${champ}.html">
<div class="build">
  <div class="preview">
...
(function () {
  ...
  function init(firstInit = true, groups = 1, duration = 1) {
    for (const door of doors) {
      ...
      //  inicio
      const pool = ['<span style="font-size: 500%;">❓</span>'];
  ...
  let spinSom = document.getElementById('spin-som')
  init();

  let click = 0;
  function autospin() {spinSom.play()
    if (click <= 0) {spinSom.play()
      spin();
    } else {spinSom.play()
      init(), spin();
    }
